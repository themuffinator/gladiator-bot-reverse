...
Returns the default weapon configuration filename.
=============
*/
...
Resets the internal subsystem tracking flags.
=============
*/
...
Restores cached library variables to their default values.
=============
*/
static void Botlib_ResetLibraryVariables(void)
{
	...
	g_library_variables.maxclients = 4;
	g_library_variables.maxentities = 1024;
	g_library_variables.sv_gravity = 800.0f;
	g_library_variables.sv_maxvelocity = 300.0f;
	g_library_variables.sv_airaccelerate = 0.0f;
	g_library_variables.sv_maxwalkvelocity = 300.0f;
	g_library_variables.sv_maxcrouchvelocity = 100.0f;
	g_library_variables.sv_maxswimvelocity = 150.0f;
	g_library_variables.sv_jumpvel = 224.0f;
	g_library_variables.sv_maxacceleration = 2200.0f;
	g_library_variables.sv_friction = 6.0f;
	g_library_variables.sv_stopspeed = 100.0f;
	g_library_variables.sv_maxstep = 18.0f;
	g_library_variables.sv_maxbarrier = 50.0f;
	g_library_variables.sv_maxsteepness = 0.7f;
	g_library_variables.sv_maxwaterjump = 20.0f;
	g_library_variables.sv_watergravity = 400.0f;
	g_library_variables.sv_waterfriction = 1.0f;
	g_library_variables.max_weaponinfo = 32;
	g_library_variables.max_projectileinfo = 32;
	g_library_variables.max_soundinfo = 256;
	g_library_variables.max_aassounds = 256;
	g_library_variables.forceclustering = 0;
	g_library_variables.forcereachability = 0;
	g_library_variables.forcewrite = 0;
	g_library_variables.framereachability = 0;
...
/*
=============
Botlib_ReadIntLibVarCached

Reads an integer libvar value with a fallback.
=============
*/
...
/*
=============
Botlib_ReadFloatLibVarCached

Reads a float libvar value with a fallback.
=============
*/
...
Caches the engine-controlled library variables for later use.
=============
*/
...
Initialises the AAS subsystem if needed.
=============
*/
...
Initialises the EA subsystem if needed.
=============
*/
...
Initialises the AI weapon subsystem if needed.
=============
*/
...
/*
=============
Botlib_SetupSoundSubsystem

Initialises the AAS sound subsystem if needed.
=============
*/
...
Bootstraps supporting utility subsystems.
=============
*/
...
Shuts down the supporting utility subsystems.
=============
*/
...
Shuts down the AI weapon subsystem.
=============
*/
...
Shuts down the AAS sound subsystem.
=============
*/
...
Stores the import table supplied by the engine.
=============
*/
...
Returns the currently registered import table.
=============
*/
...
Initialises the botlib library and its subsystems.
=============
*/
...
Shuts down the botlib subsystems and releases memory.
=============
*/
int BotShutdownLibrary(void)
{
	if (!g_library_initialised) {
		BotLib_Print(PRT_ERROR, "bot library already shutdown\n");
...
Returns whether the botlib has been initialised.
=============
*/
...
Returns the cached library variables.
=============
*/
