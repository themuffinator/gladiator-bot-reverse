...
/* PORT(c99): defined in g_ctf.c but never declared; p_client.c calls it
   under CTF_HOOK, where an implicit declaration is now an error. */
...
void CTFDrop_Flag(edict_t *ent, gitem_t *item);	/* PORT(types): see g_ctf.c */
