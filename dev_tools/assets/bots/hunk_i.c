...
#define W_CELLS					51
//armor
#define W_REDARMOR				55
#define W_YELLOWARMOR			20
#define W_GREENARMOR				11
#define W_ARMORSHARD				3		//while the significance of the armor shard may be minor, there
...
#define W_POWERSCREEN			30	//we don't know where you can find this, but it is included with quake2
//powerups								  code
