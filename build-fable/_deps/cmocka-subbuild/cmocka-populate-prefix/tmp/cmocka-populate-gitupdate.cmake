...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "cmocka-1.1.7"
  WORKING_DIRECTORY "E:/Repositories/Gladiator-Bot-reverse/build-fable/_deps/cmocka-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/Repositories/Gladiator-Bot-reverse/build-fable/_deps/cmocka-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/Repositories/Gladiator-Bot-reverse/build-fable/_deps/cmocka-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
